...
internal class BuyMarketplaceOfferEvent : IPacketEvent
{
    private readonly IMarketplaceManager _marketplace;
    private readonly IItemDataManager _itemDataManager;
    private readonly IDatabase _database;

    public BuyMarketplaceOfferEvent(IMarketplaceManager marketplace, IItemDataManager itemDataManager, IDatabase database)
    {
